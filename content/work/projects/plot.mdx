...
summary_long: "I collaborated with the founder of this SaaS startup to translate our real-world pains around the Statement of Work and scope creep into a 'letter from the CEO' that accomplishes two disparate but equally important goals: generate commitment from VCs and prospective users alike."
logoSrc: "plot.png"
logoWidth: 100
logoHeight: 42
...
To borrow from the quote above, Megan Duong was "eating shit." She hadn't even made it to the _eye of the storm yet_ as
...
2. Commitment from creative freelancers who <span className="text-orange font-semibold">despise</span> scope creep and
...
To start, Megan just had the "eat shit for a while" quote from one of her mentors. She knew she wanted to build off that
...
I joined the startup's product head for another hour session to relate my own pains and workarounds running a creative
business&mdash;by that point, we had all the messaging we needed.

We decided a "letter from the CEO" format made the most sense given that Megan and her team are currently seeking VC
funding and don't yet have a product to showcase using traditional product marketing messages.

I worked closely with Megan to combine our own genuine pains as creative freelancers, define the problem space of the
all-important Statement of Work, and create a promise: *There's not only a new product waiting for you, but a community
of like-minded creative professionals, who are gearing up to&mdash;what else?&mdash;not eat shit, **together***.

Grateful to be trusted to help carry a new tech startup into its most important phase: generating commitment at launch,
when <span className="text-orange font-semibold">there's no product to market</span>... yet.

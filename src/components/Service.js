...
export const ServicePrice = ({ children }) => (
  <div className="text-3xl font-medium mr-8">{children}</div>
)

export const ServiceButton = ({ children, to }) => (
  <button className="!text-white text-base font-bold bg-orange hover:bg-sea transition-all rounded-lg">
